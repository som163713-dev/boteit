...
# بعضی جاها (مثل Render قدیم) هنوز postgres:// می‌دن که SQLAlchemy جدید
# دیگه قبولش نمی‌کنه؛ به‌صورت خودکار به postgresql:// تبدیلش می‌کنیم.
...
engine = create_engine(
    DATABASE_URL,
    # check_same_thread فقط برای SQLite لازمه؛ برای Postgres باید حذف بشه
    # وگرنه psycopg2 با ارور مواجه می‌شه.
